    ...
    where TCollectionItem : struct
  {
    ...
    public override void Serialize(object data, ref IDictionary<string,string> result, int[] collectionIndices)
    {
      ...
      case CollectionKeyType.Aggregate:
        ...
        ISimpleMapping<TCollectionItem> mapAs = (ISimpleMapping<TCollectionItem>) this.MapAs;
    ...
    /// </summary>
    public ValueTypeCollectionMapping() : this(null, null, true) {}
    ...
    /// Is root mapping.
    /// </param>
    protected ValueTypeCollectionMapping(IMapping parentMapping,
