...
namespace CSF.Collections
{
  ...
  internal class BagEqualityComparer<TItem> : IEqualityComparer, IEqualityComparer<IEnumerable<TItem>>
  {
    ...
    internal BagEqualityComparer() : this(null, null) { }

    internal BagEqualityComparer(IEqualityComparer<TItem> itemEqComparer = null, IComparer<TItem> itemComparer = null)
    {
